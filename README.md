...
4. Need to find last version that supported OpenCL, to add options for compare/compatibility for AMD. Last version to support it is unknown, but its around the one LM Studio 0.2.24 used.
